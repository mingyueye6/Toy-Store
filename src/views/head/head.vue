...
<!--                <s>|</s>
    ...
    <div class="hd_main cle">
        ...
        <router-link to="/app/home/index" class="lizi_logo">
            <img src="../../static/images/head/loginlogo.png" alt="娃娃商城">
        </router-link>

        </div>
        <div class="search_box">
                <input class="sea_input" type="text" placeholder="搜索有惊喜" name="keywords" id="keyword" v-model="searchWord">
                <button  class="sea_submit" @click="searchSubmit">点一点</button>
        </div>
...
.search_box {
    ...
    width:300px;
    height:29px;
    border:1.5px solid #dabb92;
    border-right:0;
    background-color:#fff;
    overflow:hidden;
    box-shadow:2px 1px 1px rgba(218,187,146,0.5) inset
}
.sea_input {
    float:left;
    width:228px;
